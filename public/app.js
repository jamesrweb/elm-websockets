...
var $author$project$Main$Model = F2(
	function (messages, draft) {
		return {y: draft, A: messages};
	});
...
var $author$project$Main$incomingMessage = _Platform_incomingPort('incomingMessage', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$incomingMessage($author$project$Main$GotMessage);
};
var $author$project$Main$ChatMessage = F2(
	function (content, chatType) {
		return {O: chatType, F: content};
	});
var $author$project$Main$Incoming = 1;
var $author$project$Main$Outgoing = 0;
		...
		switch (msg.$) {
			case 1:
				var messages = A2(
					...
					_List_fromArray(
						[
							A2($author$project$Main$ChatMessage, model.y, 0)
						]));
				return _Utils_Tuple2(
					A2($author$project$Main$Model, messages, ''),
					$author$project$Main$outgoingMessage(model.y));
			case 0:
				var value = msg.a;
				...
				if (!_v1.$) {
					...
					var messages = A2(
						...
						_List_fromArray(
							[
								A2($author$project$Main$ChatMessage, message, 1)
							]));
					return _Utils_Tuple2(
						_Utils_update(
							model,
...
var $author$project$Main$SendMessage = {$: 1};
var $author$project$Main$formatChatMessage = function (message) {
	var _v0 = message.O;
	if (_v0 === 1) {
		return 'Them: ' + message.F;
	} else {
		return 'You: ' + message.F;
	}
};
var $elm$html$Html$li = _VirtualDom_node('li');
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Main$chatMessageToListItem = function (message) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$Main$formatChatMessage(message))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Socket chat')
									])),
								A2(
								$elm$html$Html$label,
								_List_Nil,
				...
				$elm$html$Html$ul,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$chatMessageToListItem, model.A))
			]));
};
